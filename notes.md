...
| **3 (final)** | **tiny, 3 folds, 18 ep, BCE, cosine LR** | **0.384** | **0.457** | **0.433** | Capacity + epochs. **rawF1 0.457 is inside the stated 0.45–0.58 band.** Shipped. |
...
Remaining levers, highest-ROI first (each ~+0.02–0.05, validate on OOF):
...
3. **ConvNeXt-V2-Small / longer (24–30 ep)** capacity for rare classes.
