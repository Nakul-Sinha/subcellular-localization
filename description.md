...
Realistically, expect a fused model to reach raw macro-F1 ≈ 0.45–0.58 (and a score — see Evaluation — of about 0.40–0.50). A constant/most-common-set prediction scores ≈ 0.
